...
const HeroSection = () => {
  ...
  //   return (
  //     <div className="flex flex-col items-center mr-6 p-4 border border-gray-300 rounded-lg transition duration-300 ease-in-out transform hover:scale-105 shadow-md shadow-blue-100 md:shadow-md md:shadow-blue-400">
